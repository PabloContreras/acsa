...
<html>
  ...
  <fieldset>
    ...
    <center><a href="/panelMaestro" button type="submit" class="btn btn-primary">Aceptar</a>
     <a href="/panelMaestro" button type="submit" class="btn btn-primary">Regresar</a></center>
    </div>
  </fieldset>
</form>
</div><!-- /.login-box-body -->
